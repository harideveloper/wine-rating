...
def deploy_model(
    ...
    model_name = registered_model.metadata.get("resource_name")
    if not model_name:
    ...
    deployed_model_display_name = (
        f"{registered_model.metadata.get('display_name', 'model')}-deployed"
    )
    ...
    try:
        ...
        deployed_model.uri = endpoint_to_use.resource_name
