...
# 2. Train model
@component(packages_to_install=["pandas==1.3.5", "scikit-learn==0.24.2", "numpy==1.21.6"], base_image="python:3.9")
...
def wine_batch_pipeline(
    ...
    region: str,
    machine_type: str = "n1-standard-4",
    model_name: str = "wine-rating-batch-model"
):
    # Step 1: Load data
...
# Compile function
def compile_pipeline(output_file: str = "wine_batch_pipeline.json"):
    """Compile the pipeline."""
    compiler.Compiler().compile(
        pipeline_func=wine_batch_pipeline,
